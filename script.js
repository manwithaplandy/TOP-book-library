...
function viewLibrary() {
  ...
  myLibrary.forEach((book) => {
    ...
    if (book.read != "read") {
      // Set mark read button according to read status
      readButton.textContent = "Mark Read";
    } else {
      readButton.textContent = "Mark Unread";
    }
...
function validateField(field) {
  if (!field.value) {
    field.setCustomValidity("Please enter a value");
...
//Set event listeners on the fields to validate
const title = document.getElementById("title");
title.addEventListener("input", () => validateField(title));

const author = document.getElementById("author");
author.addEventListener("input", () => validateField(author));

const pages = document.getElementById("pages");
pages.addEventListener("input", () => validateField(pages));
